...
<head>
	...
	<link type="text/css" rel="stylesheet" href="/assets/calcy/css/calclayout.css"  />	 
	<script type="text/javascript" src="/assets/calcy/js/jquery-1.8.0.min.js"></script>
	<script type="text/javascript" src="/assets/calcy/js/oscZenoedited.js" ></script>           
	<script type="text/javascript" src="/assets/calcy/js/jquery-ui.min.js"></script>
