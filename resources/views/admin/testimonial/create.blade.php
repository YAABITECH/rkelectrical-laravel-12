...
@section('xmt_tit', 'Create Testimonial| Admin')
@push('headcss')
...
@section('content')
    <div class="container mt-3">
        <h1 class="text-center text-primary fs-5 lh-lg">Create Testimonial</h1>
        ...
        <form method="post" action="{{ route('admin.testimonial.store') }}" enctype="multipart/form-data">
            ...
            <div class="form-group py-3">
                ...
                <input type="number" class="form-control" name="star" id="star" max="5" value="{{ old('star',5) }}" required>
            </div>
            <div class="form-group py-3">
                <label for="content" class="form-label">Content *</label>
                <textarea name="content" id="content" rows="3" novalidate>{{ old('content') }}</textarea>
            </div>
            <div class="form-group py-3">
            ...
            <div class="form-group py-3">
                <button type="submit" class="btn btn-block btn-primary">Create Testimonial</button>
            </div>
        </form>
    </div>
@endsection
