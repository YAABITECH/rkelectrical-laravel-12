...
@section('xmt_tit', 'Practice SubTopic | Admin')
...
@section('content')
    <div class="container mt-3">
        <h1 class="text-center text-primary fs-5 lh-lg">Practice SubTopics List</h1>
        <div class="text-center m-1 mb-3">
            <a class="btn btn-primary btn-sm" href="{{ route('admin.practice.subtopic.create',['subject' => $subject, 'topic' => $topic]) }}" role="button"><i class="fa-solid fa-plus"></i></a>
            ...
            <a class="btn btn-primary btn-sm" href="{{ route('admin.practice.subtopic.arrange') }}" role="button"><i class="fa-solid fa-layer-group"></i></a>
                        ...
                        @foreach ($subtopics as $subtopic)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('admin.practice.subtopic.edit', $subtopic->id) }}" class="btn btn-success btn-sm"><i class="fa-solid fa-edit"></i></a>
                                    ...
                                    <a href="{{route('admin.practice.question.manage', ['subject' => $subtopic->subject_id, 'topic' => $subtopic->topic_id, 'subtopic' => $subtopic->id])}}" class="btn btn-primary btn-sm"><i class="fa-regular fa-rectangle-list"></i></a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
        ...
        <div class="d-flex justify-content-between align-items-center mt-3">
            <div><small>{{$count}} of {{$totalCount}} {{$totalCount>1?'subtopics':'subtopic'}}</small></div>
            ...
            <div class="modal-body">
                <form action="" method="get" id="filtform">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select name="topic" id="topic_id" class="form-select xfilter_field">
                    ...
                    <div class="pt-2">
                        <input type="hidden" name="queryurl" class="queryurl" value="/admin/practice/subtopic">
