...
@section('xmt_tit', 'Create Practice Subject | Admin')
...
<div class="container mt-3">
    <h1 class="text-center text-primary fs-5 lh-lg">Create Practice Subject</h1>
    ...
    @endif
    <form method="post" action="{{ route('admin.practice.subject.store') }}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-group py-3">
            ...
            <div id="helpulink" class="form-text">{{config('app.url')}}/practice/subject/</div>
        </div>
        <div class="form-group py-3">
        ...
        <div class="form-group py-3">
            <button type="submit" class="btn btn-block btn-primary">Create Subject</button>
        </div>
    </form>
<div>
@endsection
