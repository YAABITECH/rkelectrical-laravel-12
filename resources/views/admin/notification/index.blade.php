...
@section('xmt_tit', 'Notifications | Admin')

@section('content')
    <div class="container mt-3">
        <h1 class="text-center text-primary fs-5 lh-lg">Notifications</h1>
        <div class="text-center m-1 mb-3">
            <a class="btn btn-primary btn-sm" href="{{ route('admin.notification.create') }}" role="button"><i class="fa-solid fa-plus"></i></a>
        ...
        @foreach ($notifications as $notification)
            <div class="card shadow border-0 rounded mb-4">
                ...
                <div class="card-body">
                    <h6 class="card-subtitle mb-2 text-muted">{{ $notification->body }}</h6>
                    <p class="card-text">{{ $notification->url }}</p>
                </div>
                <div class="card-footer border-0">
                    <a href="{{ route('admin.notification.edit', $notification->id) }}" class="btn btn-primary btn-sm"><i class="fa-solid fa-edit"></i></a>
        ...
        <div class="d-flex justify-content-between align-items-center mt-3">
            <div><small>{{$count}} of {{$totalCount}} {{$totalCount>1?'notifications':'notification'}}</small></div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="" method="get" id="filtform">
                    ...
                    <div class="pt-2">
                        <input type="hidden" name="queryurl" class="queryurl" value="/admin/notification">
