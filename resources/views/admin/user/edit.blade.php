...
@section('xmt_tit', 'Edit User | Admin')

@push('headcss')
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/tempusdominus-bootstrap-4/5.1.2/css/tempusdominus-bootstrap-4.min.css" />
@endpush
@php
  $oldccode = old('ccode', $user->ccode);
@endphp
@section('content')
<div class="container mt-3">
    <h1 class="text-center text-primary fs-5 lh-lg">User Edit</h1>
    ...
    <form method="post" action="{{ route('admin.user.update',$user->id) }}" enctype="multipart/form-data">
        ...
        <div class="form-group mb-3">
            ...
            <input type="text" class="form-control" name="phone" id="phone" value="{{ old('phone',$user->phone) }}" required readonly onfocus="this.removeAttribute('readonly');">
        </div>
        <div class="form-group mb-3">
            ...
            <div class="input-group" id="show_hide_password">
                ...
                <div class="input-group-append">
                    <span class="input-group-text">
                        <a href="" onclick="return false;"><i class="fa fa-eye" aria-hidden="true"></i></a>
                    </span>
                </div>
            </div>
            <div class="mt-2">
        ...
        <div class="form-group mb-3">
            ...
            <input type="email" class="form-control" name="email" id="email" value="{{ old('email',$user->email) }}" readonly onfocus="this.removeAttribute('readonly');">
        </div>
        <div class="form-group mb-3">
            <label for="dob" class="form-label">Date of Birth</label>
            <div class="input-group date datetimepicker-input" id="dobpicker" data-target-input="nearest">
                <input type="text" class="form-control datetimepicker-input" id="dob" name="dob" data-target="#dobpicker" value="{{ old('dob',$user->dob) }}">
